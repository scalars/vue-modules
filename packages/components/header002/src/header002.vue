...
class Header002 extends Vue {
  // Parameters
  @Prop({ type: String, default: "60px" }) height: string | undefined;
  @Prop({ type: Boolean, default: false }) fixed: boolean | undefined;
  @Prop({ type: String, default: null }) icon: string | undefined;
  // data
